...
#define SWCLK_TCK_PIN                GPIO_PIN_13//GPIO_PIN_7
#define SWCLK_TCK_PIN_Bit            13//7

#define SWDIO_OUT_PIN_PORT           GPIOB
#define SWDIO_OUT_PIN                GPIO_PIN_12//GPIO_PIN_9
#define SWDIO_OUT_PIN_Bit            12//9

#define SWDIO_IN_PIN_PORT            GPIOB
#define SWDIO_IN_PIN                 GPIO_PIN_14//GPIO_PIN_8
#define SWDIO_IN_PIN_Bit             14//8
